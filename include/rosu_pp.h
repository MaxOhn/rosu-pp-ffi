 ...
 */
typedef struct AdjustedBeatmapAttributes AdjustedBeatmapAttributes;
 ...
 */
enum rosu_pp_FfiResult rosu_pp_beatmap_attrs_apply_clock_rate(const struct BeatmapAttributesHandle *handle, struct AdjustedBeatmapAttributes *out);
 ...
 */
enum rosu_pp_FfiResult rosu_pp_beatmap_from_bytes(const uint8_t *bytes, size_t len, struct BeatmapHandle * *out);
 ...
 * `rosu_pp_mods_free`.
 */
enum rosu_pp_FfiResult rosu_pp_mods_parse_with_mode(const char *s, bool deny_unknown_fields, enum rosu_pp_GameMode mode, struct rosu_pp_ModsHandle * *out);
 ...
 * `handle` or `out` is null.
 */
enum rosu_pp_FfiResult rosu_pp_beatmap_attrs_hit_windows(const struct BeatmapAttributesHandle *handle, struct HitWindows *out);
 ...
 * `rosu_pp_mods_free`.
 */
enum rosu_pp_FfiResult rosu_pp_mods_parse(const char *s, bool deny_unknown_fields, struct rosu_pp_ModsHandle * *out);
 ...
 * **Returns:** The computed value, or the type's default value if `handle` is null.
 */
size_t rosu_pp_beatmap_hit_object_count(const struct BeatmapHandle *handle);
 ...
 * **Returns:** The computed value, or the type's default value if `handle` is null.
 */
size_t rosu_pp_beatmap_timing_point_count(const struct BeatmapHandle *handle);
 ...
 * **Returns:** The computed value, or the type's default value if `handle` is null.
 */
size_t rosu_pp_beatmap_difficulty_point_count(const struct BeatmapHandle *handle);
 ...
 * **Returns:** The computed value, or the type's default value if `handle` is null.
 */
size_t rosu_pp_beatmap_effect_point_count(const struct BeatmapHandle *handle);
 ...
 * **Returns:** The computed value, or the type's default value if `handle` is null.
 */
size_t rosu_pp_beatmap_break_count(const struct BeatmapHandle *handle);
 ...
 * **Returns:** The computed value, or the type's default value if `handle` is null.
 */
size_t rosu_pp_beatmap_hit_sound_count(const struct BeatmapHandle *handle);
