...
use rosu_pp_ffi::{
    rosu_pp_AdjustedBeatmapAttributes, rosu_pp_DifficultyAttributes, rosu_pp_FfiResult,
    rosu_pp_GameMode, rosu_pp_HitWindows, rosu_pp_PerformanceAttributes,
    rosu_pp_beatmap_attrs_apply_clock_rate, rosu_pp_beatmap_attrs_ar,
    rosu_pp_beatmap_attrs_builder_ar, rosu_pp_beatmap_attrs_builder_clock_rate,
    rosu_pp_beatmap_attrs_builder_cs, rosu_pp_beatmap_attrs_builder_difficulty,
    rosu_pp_beatmap_attrs_builder_free, rosu_pp_beatmap_attrs_builder_hp,
    rosu_pp_beatmap_attrs_builder_map, rosu_pp_beatmap_attrs_builder_mode,
    rosu_pp_beatmap_attrs_builder_mods, rosu_pp_beatmap_attrs_builder_od,
    ...
    rosu_pp_beatmap_free, rosu_pp_difficulty_ar, rosu_pp_difficulty_calculate,
    rosu_pp_difficulty_clock_rate, rosu_pp_difficulty_cs, rosu_pp_difficulty_free,
    rosu_pp_difficulty_hardrock_offsets, rosu_pp_difficulty_hp, rosu_pp_difficulty_lazer,
    rosu_pp_difficulty_mods, rosu_pp_difficulty_od, rosu_pp_difficulty_passed_objects,
    rosu_pp_gradual_difficulty_free, rosu_pp_gradual_difficulty_next,
    rosu_pp_gradual_performance_free, rosu_pp_gradual_performance_next, rosu_pp_mods_free,
    rosu_pp_mods_free_string, rosu_pp_performance_accuracy, rosu_pp_performance_calculate,
    rosu_pp_performance_combo, rosu_pp_performance_free, rosu_pp_performance_misses,
    rosu_pp_performance_mods, rosu_pp_performance_state, rosu_pp_score_state_new,
    rosu_pp_score_state_total_hits, rosu_pp_strains_free,
};
...
fn calculate_null_handles() {
    unsafe {
        ...
        let mut attrs = std::mem::zeroed::<rosu_pp_DifficultyAttributes>();
        let result =
            rosu_pp_difficulty_calculate(null_diff as *mut _, null_map as *const _, &mut attrs);
        assert_eq!(result, rosu_pp_FfiResult::NullPointer);

        let mut perf_attrs = std::mem::zeroed::<rosu_pp_PerformanceAttributes>();
...
fn gradual_next_null() {
    unsafe {
        ...
        let state = rosu_pp_score_state_new();
        let result =
            rosu_pp_gradual_performance_next(null_handle as *mut _, &state, &mut perf_attrs);
        assert_eq!(result, rosu_pp_FfiResult::NullPointer);
    }
}
...
fn beatmap_attrs_getters_null() {
    unsafe {
        ...
        let mut hw = std::mem::zeroed::<rosu_pp_HitWindows>();
        let result = rosu_pp_beatmap_attrs_hit_windows(cast, &mut hw);
        assert_eq!(result, rosu_pp_FfiResult::NullPointer);

        let mut adj = std::mem::zeroed::<rosu_pp_AdjustedBeatmapAttributes>();
